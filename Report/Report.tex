...
\emph{Trello}\cite{trello} is a free web-based project management application that uses the paradigm \emph{kanaban}\footnote{A Japanese word that roughly means ``card'' or ``signboard''.}, which is a method made famous by the car manufacturer Toyota in the 1980s for supply management. 
