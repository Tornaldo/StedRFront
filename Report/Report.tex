...
\centering
\begin{tabular}{ l  p{11cm} }
    F4.1     & System shall show images tagged with the tag of the particular place.                                             \\
    \end{tabular}
\label{tab:req_stories}
\caption{Stories}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{| l | l | l |}
        ...
        Perform code inspection (server)    & Christian Frøystad      &                \\ \hline
...
% FIXME SIMON: write about test levels

\subsection{System test level}
\subsection{Integration test level}
\subsection{User acceptance test level}
