...
We suggest to make calls for the picture details in parallel and not one after another. If given enough threads to process, this can speed up the time to load the items to almost one second for all instead of one second each.
