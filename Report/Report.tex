...
The goal of the project is to produce a prototype of the system that might be experimented with and tested in different contexts. The prototype should be accompanied by excellent documentation, both for users and developers.
...
Dropbox\cite{dropbox} is a file hosting service that offers cloud storage and file synchronization, much like Google Drive. The group used only Dropbox as an collaboration tool with the customer, as in sharing files, etc.. Google Drive, with the possibility to use the embedded office suite, Google Docs, was found to be the best alternative as an collaboration tool for document writing.
...
\subsubsection{Email}
Email was used for communicating with both the customer and advisor. Within the group it was used for time sensitive matters.
...
The chapter follows the outline from section~\ref{subsec:phases}.
